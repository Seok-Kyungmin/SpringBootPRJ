...
public interface IMelonMapper {
	 ...
	 * @return 저장 결과
	 */
	int updateSongAddFiled(String colNm, String singer, String nickname) throws Exception;
	 ...
	 * @return 저장 결과
	 */
	int updateSongAddListFiled(String colNm, String singer, List<String> member) throws Exception;

	/**
	 * 가수의 Nickname 필ㄷ 추가 및 값 저장하기
	 *
	 * @param colNm 저장할 컬렉션 이름
