...
public interface IMyRedisMapper {
    ...
    /**
     * Set 타입에 JSON형태로 람다식을 이용하여 저장된 값 가져오기
     *
     * @param redisKey 가져올 RedisKey
     * @return 결과 값
     */
    Set<RedisDTO> getRedisZSetJSONRamda(String redisKey) throws Exception;

    /**
     * ZSet타입에 JSON 행태로 저장하기
     *
     * @param redisKey Redis저장 키
     * @param pLit 저장할 정보들
     * @return 저장 성공 여부
